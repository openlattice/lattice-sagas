...
const GET_PT_METADATA_FOR_ENTITY_SET :'GET_PT_METADATA_FOR_ENTITY_SET' = 'GET_PT_METADATA_FOR_ENTITY_SET';
const getPropertyTypeMetaDataForEntitySet :RequestSequence = newRequestSequence(GET_PT_METADATA_FOR_ENTITY_SET);

const GET_PT_METADATA_FOR_ENTITY_SETS :'GET_PT_METADATA_FOR_ENTITY_SETS' = 'GET_PT_METADATA_FOR_ENTITY_SETS';
const getPropertyTypeMetaDataForEntitySets :RequestSequence = newRequestSequence(GET_PT_METADATA_FOR_ENTITY_SETS);
